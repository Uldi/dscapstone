...
See appendix for ngram details. The distribution analysis of the ngram frequency shows that few ngrams (<100) cover most of the corpus. See appendix for top 100 ngram diagrams. 
...
## Appendix
Here is a list of the topmost 1-, 2-, 3- and 5-grams
```{r list most frequent terms, eval=TRUE}
listMostFrequentTerms(tdm1, 10, ngram=1)
listMostFrequentTerms(tdm2, 10, ngram=2)
listMostFrequentTerms(tdm3, 10, ngram=3)
listMostFrequentTerms(tdm4, 10, minFreq=10, ngram=4)
```
